...
{
	private var curOption:OptionBase = null;
	private var curSelected:Int = 0;
	private var optionsArray:Array<OptionBase>;
	...
	public function addOption(option:OptionBase) {
	...
	override function update(elapsed:Float)
	{
		...
		if(nextAccept <= 0)
		{
			...
			{
				var leOption:OptionBase = optionsArray[curSelected];
	...
	function updateBind(?text:String = null, ?option:OptionBase = null)
	{
	...
	function updateTextFrom(option:OptionBase) {
