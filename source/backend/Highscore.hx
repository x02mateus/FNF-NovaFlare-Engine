...
class Highscore
{
	...
	public static function getMsGroup(song:String, group:Array<Float>):Array<Float>
	{
		var daSong:String = formatSong(song, group);
	...
	public static function getTimeGroup(song:String, group:Array<Float>):Array<Float>
	{
		var daSong:String = formatSong(song, group);
