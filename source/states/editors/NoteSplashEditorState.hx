...
class NoteSplashEditorState extends MusicBeatState
{
    ...
    { 
        ...
        if (!blockInput && config != null && config.animations != null && config.animations.exists(curAnim) && curAnim != null && curAnim.length > 0)
        {
            ...
            var moveKeysP = [virtualPad.buttonLeft.justPressed || FlxG.keys.justPressed.LEFT,virtualPad.buttonRight.justPressed || FlxG.keys.justPressed.RIGHT, virtualPad.buttonUp.justPressed || FlxG.keys.justPressed.UP, virtualPad.buttonDown.justPressed || FlxG.keys.justPressed.DOWN];
            ...
            var moveKeys = [virtualPad.buttonLeft.pressed || FlxG.keys.pressed.LEFT, virtualPad.buttonRight.pressed || FlxG.keys.pressed.RIGHT, virtualPad.buttonUp.pressed || FlxG.keys.pressed.UP, virtualPad.buttonDown.pressed || FlxG.keys.pressed.DOWN];
