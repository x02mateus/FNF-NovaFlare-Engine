...
class ChartingState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	override function create()
	{
		...
		fullTipText.text = controls.mobileC ? [
			...
			"Z - Hide Action virtualPad Buttons",
			"V/D - Zoom in/out",
			""
			#if FLX_PITCH
	...
	override function update(elapsed:Float)
	{
		...
		var holdingAlt:Bool = virtualPad.buttonG.justPressed || FlxG.keys.pressed.ALT;
		if(FlxG.sound.music != null)
		{
			if(PsychUIInputText.focusOn == null) //If not typing anything
			{
				if(virtualPad.buttonC.justPressed || FlxG.keys.justPressed.F12)
				{
                ...
                else if(virtualPad.buttonF.justPressed || FlxG.keys.justPressed.F1)
                {
                    if(controls.mobileC){
                        virtualPad.forEachAlive(function(button:FlxButton){
                            if(button.tag != 'F')
					...
					if(controls.mobileC){
						virtualPad.forEachAlive(function(button:FlxButton){
							if(button.tag != 'Z' && button.tag != 'LEFT' && button.tag != 'RIGHT' && button.tag != 'UP' && button.tag != 'DOWN')
								virtualPad.buttonUp2.visible = virtualPad.buttonDown2.visible = button.visible = !button.visible;
						});
					}
				}
				...
				else if(virtualPad.buttonLeft.justPressed || FlxG.keys.justPressed.A != virtualPad.buttonRight.justPressed || FlxG.keys.justPressed.D && !holdingAlt)
				{
					if(FlxG.sound.music.playing)
						setSongPlaying(false);

					var shiftAdd:Int = virtualPad.buttonY.pressed || FlxG.keys.pressed.SHIFT ? 4 : 1;
					...
					else if(virtualPad.buttonRight.justPressed || FlxG.keys.justPressed.D)
					{
				...
				else if(virtualPad.buttonUp.pressed || FlxG.keys.pressed.W != virtualPad.buttonDown.pressed || FlxG.keys.pressed.S || FlxG.mouse.wheel != 0)
				{
					if(FlxG.sound.music.playing)
						setSongPlaying(false);
					...
					if(mouseSnapCheckBox.checked && FlxG.mouse.wheel != 0)
					{
						...
						var timeAdd:Float = (virtualPad.buttonY.pressed || FlxG.keys.pressed.SHIFT ? 4 : 1) / (holdingAlt ? 4 : 1) * -FlxG.mouse.wheel * snap;
					...
					{
						var speedMult:Float = (virtualPad.buttonY.pressed || FlxG.keys.pressed.SHIFT ? 4 : 1) * (FlxG.mouse.wheel != 0 ? 4 : 1) / (holdingAlt ? 4 : 1);
						if(virtualPad.buttonUp.pressed || FlxG.keys.pressed.W || FlxG.mouse.wheel > 0)
							FlxG.sound.music.time -= Conductor.crochet * speedMult * elapsed / curZoom;
						else if(virtualPad.buttonDown.pressed || FlxG.keys.pressed.S || FlxG.mouse.wheel < 0)
							FlxG.sound.music.time += Conductor.crochet * speedMult * elapsed / curZoom;
					}
				...
				else if(virtualPad.buttonX.justPressed || FlxG.keys.justPressed.SPACE)
				{
		...
		if(PsychUIInputText.focusOn == null && lastFocus == null)
		{
			...
			else if(canContinue)
			{
				...
				else if(virtualPad.buttonV.justPressed || FlxG.keys.justPressed.Z != virtualPad.buttonD.justPressed || FlxG.keys.justPressed.X) //Decrease/Increase Zoom
				{
					if(virtualPad.buttonV.justPressed || FlxG.keys.justPressed.Z)
		...
		if (controls.mobileC)
		{
			for (touch in FlxG.touches.list)
			{
				...
				if(touch.x >= minX && touch.x < gridBg.x + gridBg.width)
				{
					...
					if(virtualPad.buttonY.pressed || touch.y >= gridBg.y || !prevGridBg.visible)
		...
		if(selectedNotes.length > 0)
		{
			...
			var qPress = (virtualPad.buttonDown2.justPressed || FlxG.keys.justPressed.Q);
			var ePress = (virtualPad.buttonUp2.justPressed || FlxG.keys.justPressed.E);
			var addSus = (virtualPad.buttonY.pressed || FlxG.keys.pressed.SHIFT ? 4 : 1) * (Conductor.stepCrochet / 2);
			if(qPress) addSus *= -1;
